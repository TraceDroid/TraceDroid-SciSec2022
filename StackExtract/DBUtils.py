...
def writeHTTPMetaData(httpMessage):
    ...
    try:
        ...
        db_cursor.execute(insertSql, (httpMessage['packageName'], httpMessage['srcAddr'], httpMessage['srcPort'], httpMessage['dstAddr'], httpMessage['dstPort'], httpMessage['host'], httpMessage['URL'], httpMessage['requestHeaders'], httpMessage['requestBody'], httpMessage['responseHeaders'], httpMessage['responseBody'], httpMessage['protocol'], httpMessage['method'], httpMessage['content-type']))
